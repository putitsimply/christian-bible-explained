...
* **Rules for offerings and sacrifices[^gl_sacrifice] (Leviticus 1 to 7):** God gives Moses instructions for different kinds of offerings. Some are about saying sorry for wrongdoing, some are about thankfulness, and some are about showing devotion. The idea is that worship is serious and needs care, not shortcuts.
* **Priests[^gl_priest] begin their work (Leviticus 8 to 10):** Moses sets apart Aaron (Moses’ brother) and Aaron’s sons as priests, meaning their job is to lead worship and help the people follow these rules. A dramatic moment happens when two of Aaron’s sons disobey the worship instructions, and they die. The message is that the priest role is not casual.
* **Clean and unclean (Leviticus 11 to 15):** The book explains many “clean” and “unclean” rules. These include food laws, health issues, and bodily conditions. “Unclean” here usually does not mean “dirty” in a modern insult sense. It means someone cannot take part in worship for a time, often for safety, health, or symbolic reasons.
* **The Day of Atonement[^gl_atonement] (Leviticus 16):** This is a major yearly ceremony. “Atonement” means making things right after wrongdoing. The high priest[^gl_high_priest] performs special rituals asking for forgiveness for the whole community.
* **How to live a holy life (Leviticus 17 to 27):** These chapters include rules about justice, honesty, kindness to the poor, sexual behaviour, and not copying harmful practices from surrounding nations. It also includes special festivals and rest days, including the Sabbath[^gl_sabbath] and a “Jubilee” system where land and debts were meant to be reset over time.
...
[^gl_atonement]: Making things right after wrongdoing; linked to forgiveness. ([Glossary](glossary.md#atonement))
