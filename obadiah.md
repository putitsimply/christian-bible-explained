...
In the Bible’s larger story, Edom is connected to Israel[^gl_israel] through family links (Edom is associated with Esau, the brother of Jacob/Israel). That is part of why the anger in Obadiah feels so intense: it is not just “a foreign enemy,” but a neighbour with a close history.

The book is written as prophetic poetry. That means it uses strong images and short, memorable lines, more like a speech than a history report.
...
* **A bigger idea (“the Day of the Lord”):** this phrase is used in the Bible[^gl_bible] for a time when God[^gl_god] is pictured as stepping in to judge unfairness and set things right. In Obadiah, it means what Edom did will come back on them, and other nations are not “untouchable” either.
...
One thing that makes Obadiah interesting is that it connects a local conflict (Judah and Edom) to a larger moral message. It says that how you treat vulnerable people matters, even during war or disasters, and that taking advantage of suffering is not “smart”, it is wrong.
