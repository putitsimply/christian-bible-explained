...
- For glossary help: keep the term as a normal link to `glossary.md#...`, but render it as an HTML link with a `title` tooltip containing the glossary definition, e.g. `<a href="glossary.md#term" title="...">term</a>`.
